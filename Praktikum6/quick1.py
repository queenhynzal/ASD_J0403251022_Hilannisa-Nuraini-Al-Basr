...
4. Pointer leftmark bergerak dari kiri untuk mencari nilai yang lebih besar dari pivot.
5. Pointer rightmark bergerak dari kanan untuk mencari nilai yang lebih kecil dari pivot.
...
8. Proses ini dilakukan secara rekursif sampai seluruh data terurut dari kecil ke besar.
