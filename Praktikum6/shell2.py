...
5. Pada proses perbandingan, nilai yang lebih besar ditempatkan
   di depan sehingga menghasilkan urutan dari terbesar ke terkecil.
6. Nilai gap diperkecil secara bertahap sampai bernilai 0.
7. Setelah proses selesai, data terurut dari terbesar ke terkecil.
